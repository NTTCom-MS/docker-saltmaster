...
class HealthCheckHandler(BaseHTTPRequestHandler):
    ...
    def check_supervisord_status(self):
        ...
        p = subprocess.Popen("supervisorctl status | awk '{ print $2 }' | sort | uniq | wc -l", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        linecount=0
        lastline=""
        ...
        return (retval==0 and linecount==1 and lastline=="1")
